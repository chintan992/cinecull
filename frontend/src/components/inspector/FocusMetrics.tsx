  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <span className="text-[9px] text-chrome-400 uppercase tracking-wider">Sharpness</span>
      ...
      />
      <div className="grid grid-cols-2 gap-x-3 gap-y-1 text-[8px] font-mono text-chrome-500">
